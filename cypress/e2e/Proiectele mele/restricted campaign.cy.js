...
describe('Etvas Test', () => {
    it('Campaign', () =>{
        ...
        cy.get('input[name="offerSets[0].name"]').type('pending campaign',{force: true})
        ...
        cy.get('input[name="name"]').type('pending campaign',{force: true})
        cy.get("input[placeholder='Title']").type('pending campaign',{force: true})
        cy.get('textarea').first().type('pending campaign',{force: true})
        cy.get('textarea[name="description[en]"]').type('pending campaign',{force: true})
